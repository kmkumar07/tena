...
const meta: Meta<createFeatureComponent> = {
  ...
  parameters: {
    docs: {
      source: {
        code: `
        <div class="cerate-feature-wrapper pt-8">
        <div class="inner-form-wrapper">
          <div class="header-section pb-6">
            <div class="flex align-center justify-between">
              <div class="flex align-center">
                ...
                <p class="mat-headline-5 text-purple-lighten-1">Create Feature</p>
              </div>
            </div>
          </div>
          <div class="form-with-sample flex border-2">
            <div class="form-left pt-10 pl-10 pr-5 pb-6 mr-6 border-2 main-bg">
              <div class="header-section pr-5">
                <h5 class="text-blue-darken mat-subtitle-1 font-weight-500">Features Details</h5>
              </div>
              <div class="form-wrapper pr-5">
                <form [formGroup]="featureForm">
                  <div class="form-container mt-6">
                    ...
                    <div class="input-wrapper">
                      <div class="flex align-center mb-2">
                        ...
                        <mat-icon class="material-symbols-outlined pointer ml-3 help-icon text-text text-primary"
                          [ngxTippy]="type" [tippyProps]="{ placement: 'right', interactive: true }">help</mat-icon>
                  ...
                  ">
                    ...
                    <div *ngIf="this.featureForm.value.unit || this.featureForm.value.type == 'custom'">
                          ...
                          <div class="flex align-center wrap mb-3" [formGroupName]="i">
                            <div class="flex align-center wrap w-88">
                              <div class="input-wrapper pr-2">
                                ...
                                <mat-form-field appearance="outline" class="border-2">
                                  <input (input)="setName(i)" required matInput placeholder="Enter here"
                            ...
                            i != 0
                          " mat-stroked-button disableRipple class="upper-case primary light medium px-1 ml-2 text-grey-darken"
                      ...
                      <div>
                        <button mat-button color="primary" class="small-font-14" (click)="toggleUnlimited()">
                          <!-- <mat-icon class="add-course-btn"></mat-icon> -->
                          {{ unlimitedButtonLabel }}
                        </button>
                      </div>
                      <button mat-button color="primary" class="small-font-16 mt-4" (click)="addLevels()" *ngIf="!isRangeSelected">
                        <mat-icon class="add-course-btn mat-primary">add</mat-icon>Add Entitlement
                      </button>
                    </div>
                  </div>
                </form>
            ...
            <div class="sample-right">
              <div class="inner-block border-2 main-bg">
                ...
                <div class="mt-4 mb-2">
                  ...
                  <button mat-button color="primary" class="medium px-1 mb-3 font-weight-500" (click)="switchSample()">
                    Try a Sample
                  </button>
                </div>
                <div class="mb-2">
                  ...
                  <button mat-button color="primary" class="medium px-1 mb-3 font-weight-500" (click)="rangeSample()">
                    Try a Sample
                  </button>
                </div>
                <div class="mb-2">
                  ...
                  <button mat-button color="primary" class="medium px-1 mb-3 font-weight-500" (click)="quantitySample()">
                    Try a Sample
                  </button>
                </div>
                <div class="">
          ...
          <div class="footer-section py-6">
            <div class="action-btns flex align-center justify-between">
              <mat-checkbox color="primary" class="font-weight-500 checkbox ml-n-3" checked>Active</mat-checkbox>
              <div>
                <button mat-stroked-button color="primary" class="mr-2 large" [mat-dialog-close]="true" (click)="onDelete()">
                  Back
                </button>
                <button mat-flat-button color="primary" class="large" type="submit" (click)="onSubmit()" [disabled]="
                !featureForm.valid &&
